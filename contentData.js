const SCREEN_CONTENT={
  ...
  jobs:{title:'채용정보 매칭',desc:'내담자의 희망 조건을 기준으로 현재 지원 가능한 채용정보를 취합하고 상담용 추천 결과로 정리합니다.',formTitle:'내담자 조건 입력',apiTitle:'실서비스 연동 구조',apiDesc:'상용 모드에서는 서버의 워크넷/고용24 및 채용정보 API 연동이 필요합니다. 개발 모드에서만 샘플 공고 기반 매칭 로직을 확인할 수 있습니다.',resultTitle:'AI 정리 결과',recentTitle:'최근 저장된 채용정보 매칭'},
