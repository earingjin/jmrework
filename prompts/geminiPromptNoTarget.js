...
- aiLifeQuestions 1~5번은 "진로 설정 질문"으로 작성하세요. 내담자가 자신의 흥미와 경험을 바탕으로 원하는 일의 방향, 중요하게 여기는 근무조건, 피하고 싶은 환경, 우선 탐색할 직무군, 진로 선택 기준을 스스로 정리하도록 돕는 질문이어야 합니다.
- aiLifeQuestions 1~5번은 특정 직업을 바로 정답처럼 제시하지 말고, 내담자가 여러 가능성 중에서 자신의 기준을 좁혀가도록 묻는 방식으로 작성하세요.
- aiLifeQuestions 6~10번은 "파생되는 2차 질문"으로 작성하세요. 1~5번 답변에서 이어 물을 수 있는 후속 질문으로, 선택 이유·현실적 제약·준비 정도·검증 방법·다음 행동을 구체화해야 합니다.
- aiLifeQuestions 6~10번은 내담자의 답변을 실행 가능한 탐색 과제나 확인 행동으로 연결하는 질문이어야 합니다. 예: 정보탐색, 직무 인터뷰, 채용공고 비교, 필요한 역량 확인, 단기 실행 계획 수립.
