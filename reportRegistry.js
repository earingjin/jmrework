  ...
  const definitions = [
    {
      ...
      noticeTitle: '★이용 전 필독★',
      description: '1. 본 리포트는 상담자의 사전 준비용 초안입니다.<br>2. 본 리포트는 내담자와 공유하지 않습니다.<br>3. 직업흥미검사, 참여자에게 연결할 시사점, 희망 직무 여부는 필수 입력 사항입니다.<br>4. 리포트는 상담사가 직접 편집할 수 있습니다.<br>5. 내담자의 정보는 저장되지 않지만, 개인정보 보호를 위해 가명으로 입력해주세요.',
      available: true,
      menuOrder: 10,
    ...
    },
    {
      ...
      noticeTitle: '★이용 전 필독★',
      description: '1. 성공사례를 알고 싶은 직업명 또는 자격증을 검색합니다.<br>2. 자격증 검색 시 맞춤법 및 띄어쓰기에 따라 결과에 차이가 발생할 수 있습니다, <br>3. 최대 3개까지 원하는 직업을 선택합니다.<br>4. 참여자에게 연결할 시사점을 입력합니다. (이전 경력, 보유 자격, 희망 근무조건, 관심 분야 등)<br>5. 리포트는 상담사가 직접 편집할 수 있습니다. ',
      available: true,
      menuOrder: 20,
