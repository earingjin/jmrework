  ...
  const definitions = [
    {
      ...
      noticeTitle: '안내사항',
      description: '1. 본 리포트는 상담자의 사전 준비용 초안입니다.★<br>2. 본 리포트는 내담자와 공유하지 않습니다.★★<br>3. 직업흥미검사를 제외한 나머지 검사는 선택사항 입니다.<br>4. 리포트는 상담사가 직접 편집할 수 있습니다.<br>5. 내담자의 정보는 저장되지 않지만, 개인정보 보호를 위해 가명으로 입력해주세요.',
      available: true,
      menuOrder: 10,
